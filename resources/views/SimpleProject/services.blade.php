<x-project-layout>
    <x-slot name="title">Sevices</x-slot>
    <x-slot name="content">
        <div class="container mt-5">
            <h1 class="text-warning mb-5 border-bottom">Our Services</h1>
            <div class="row text-white mb-5">
                <div class="col-sm-4">
                    <i class="fas fa-search-dollar fa-2x mb-3 i-color"></i>
                    <h3>SEO</h3>
                    <p class="ss-color">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi, cum
                        voluptatibus optio quibusdam sunt vero?</p>
                </div>
